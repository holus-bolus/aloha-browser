  ...
  return (
    <ul className="hide-what-do__list">
      ...
      <li className="hide-what-do__item">
        ...
        <p className="list-subtitle hide-what-do__text">
          Stop others from peeking at your data, even when connected non‐secure
      ...
      <li className="hide-what-do__item">
        ...
        <p className="list-subtitle hide-what-do__text">
          Trick sites into thinking you’re somewhere else to access services and
          media that are restricted in your area
        </p>
      </li>
      <li className="hide-what-do__item">
        <h2 className="subheading hide-what-do__subheading">
        ...
        <p className="list-subtitle hide-what-do__text">
          Enjoy local news, entertainment, and whatever else you miss from home
