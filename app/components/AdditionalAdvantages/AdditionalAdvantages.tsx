const AdditionalAdvantages = () => {
  return (
    <section className="additional-advantages">
      <h2 className="title">... And that's not all</h2>
      <ul className="additional-advantages-list">
        <li className="additional-advantages-item">
          <h3 className="additional-advantages__subheading">
            Browser features
          </h3>
        ...
        <li className="additional-advantages-item">
          <h3 className="additional-advantages__subheading">File manager</h3>
          <ul className="additinal-advandages__inner-list">
            <li className="additional-advantages__inner-item">Manage files</li>
            <li className="additional-advantages__inner-item">Audio & video</li>
            <li className="additional-advantages__inner-item">
        ...
        <li className="additional-advantages-item">
          <h3 className="additional-advantages__subheading">Media player</h3>
          <ul className="additinal-advandages__inner-list">
            <li className="additional-advantages__inner-item">
              Photo slideshow
            </li>
        ...
        <li className="additional-advantages-item">
          <h3 className="additional-advantages__subheading">Profile</h3>
          <ul className="additinal-advandages__inner-list">
        ...
        <li className="additional-advantages-item">
          <h3 className="additional-advantages__subheading">Appearance</h3>
          <ul className="additinal-advandages__inner-list">
            <li className="additional-advantages__inner-item">Dark mode</li>
            <li className="additional-advantages__inner-item">Color themes</li>
